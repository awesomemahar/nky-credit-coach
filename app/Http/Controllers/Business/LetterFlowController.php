...
class LetterFlowController extends Controller
{
    ...
    public function flows(){
        ...
        return view('business.letters.flow.flows',compact('page','flows'));
    }
    ...
    public function flowCreate(){
        ...
        if(count($reasons) < 1){
            return redirect()->route('business.reason.index')->with('error', 'Need to have at least one active reason to create dispute.');
        }
        return view('business.letters.flow.create',compact('page','reasons','bureau_letters','furnisher_letters','agency_letters'));
    }
    ...
    public function flowCreatePost(Request  $request){
        ...
        try{
            ...
            return redirect()->route('business.letter.flows')->with('success', 'Flow created successfully.');
