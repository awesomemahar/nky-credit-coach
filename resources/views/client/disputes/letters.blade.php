            ...
            <div class="col">
                ...
                <!-- Card header -->
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="box">
                            <a href="{{ route('client.reason.index') }}" class="{{$c_color}} text-white btn btn-sm"><i
                        ...
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('client.get.dispute.letter', ['id'=>$letter->id]) }}" target="_blank">
                                            <i class="fas fa-file-pdf fa-2x"></i>
                                        </a>
                                        <a href="{{ route('client.edit.dispute.letter', ['id'=>$letter->id]) }}"  class="ml-3">
                                            <i class="fas fa-edit fa-2x"></i>
                                        </a>
                                        @if(!is_null(\App\Models\BusinessSetting::where('type','fax_client')->where('value', '1')->first()))
                                            @if($letter->company == 'TransUnion' || $letter->company == 'Experian'  || $letter->company == 'Equifax' )
                                                @if($letter->fax_sent == 0)
                                                    <a href="{{ route('client.fax.dispute.letter', ['id'=>$letter->id]) }}"  class="ml-3">
