...
<link rel="stylesheet" href="{{ asset('assets/business/vendor/@fortawesome/fontawesome-free/css/all.min.css') }}" type="text/css">

{{--<x-embed-styles />--}}

<!-- Page plugins -->
<link rel="stylesheet" href="{{ asset('assets/business/vendor/datatables.net-bs4/css/dataTables.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/business/vendor/datatables.net-buttons-bs4/css/buttons.bootstrap4.min.css') }}">
<link rel="stylesheet" href="{{ asset('assets/business/vendor/datatables.net-select-bs4/css/select.bootstrap4.min.css') }}">
