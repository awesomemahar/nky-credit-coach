...
@section('content')
    ...
    <div class="modal fade" id="new-event" tabindex="-1" role="dialog" aria-labelledby="new-event-label"
        ...
        <div class="modal-dialog modal-dialog-centered modal-secondary" role="document">
            <div class="modal-content">
                <!-- Modal body -->
                <form class="new-event--form" action="{{ url('business/reminder') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="edit-event" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-secondary" role="document">
            <div class="modal-content">
                <!-- Modal body -->
                <form class="new-event--form" action="{{ url('business/reminder/update') }}" method="POST">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label class="form-control-label">Client</label>
                            <select name="user_id" id="user_id" class="form-control edit-event--user_id " required>
