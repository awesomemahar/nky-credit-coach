                                        ...
                                        <div class="row h-100">
                                            ...
                                            <div class="col-md-11">
                                                <div class="card-body">
                                                    ...
                                                    <a class="font-10 text-info" data-toggle="modal" data-target="#exampleModalCenter">Add New Document</a>
                        ...
                        <div class="card-body">
                            <div class="row ">
                                ...
                                <div class="col-md-6 text-center mb-5">
                                    <a href="{{ route('business.credit.dispute.type',['id'=>$client->id,'type'=>'collections']) }}"  class="d-block p-5" style="border: 2px solid #e3e3e3">
                                        <i class="fas fa-file fa-3x text-info mb-2"></i> <br> Charges Off or Collections
                                    </a>
                                </div>
                                <div class="col-md-6 text-center mb-5">

                                    <a href="{{ route('business.credit.dispute.type',['id'=>$client->id,'type'=>'late_payments']) }}" class="d-block p-5" style="border: 2px solid #e3e3e3">
                        ...
                        <div class="card-body">
                            <div class="row ">
                                <div class="col-md-6">
                                    ...
                                    <a href="{{ route('client.import.report',$client->id) }}" class="btn btn-primary">Import Report</a>
                                </div>
                                <div class="col-md-6">
                                    <h4>IdentityIQ Credentials:</h4>
                                    <form action="{{ route('client.credentials.update', $client->id) }}" method="post">
                                    @csrf
                                        <div class="row">
                                        <div class="col-md-12">
