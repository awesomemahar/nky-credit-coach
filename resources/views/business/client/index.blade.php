            ...
            <div class="col">
                ...
                @endif
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ url('business/client/create') }}" class="{{$c_color}} text-white btn btn-sm"><i
                            ...
                            @foreach($clients as $client)
                                <tr>
                                    ...
                                    <td class="table-actions">
                                        <a href="{{ route('business.credit.get.profile',['id'=>$client->id,'tab'=>'dashboard']) }}" class="btn btn-sm btn-success"
                                           data-toggle="tooltip" data-original-title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ url('business/client/'.$client->id.'/edit') }}"
                                           class="btn btn-sm btn-info" data-toggle="tooltip" data-original-title="Edit">
                                            <i class="fas fa-user-edit"></i>
                                        </a>
                                        {{--<a href="{{ url('business/client/'.$client->id.'/delete') }}"--}}
