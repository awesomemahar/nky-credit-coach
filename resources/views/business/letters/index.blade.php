                ...
                <!-- Card header -->
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="box">
                            ...
                            <a href="{{ url('business/letters/create') }}" class="{{$c_color}} text-white btn btn-sm"><i
                            ...
                            @foreach($letters as $letter)
                                <tr>
                                    ...
                                    <td class="table-actions">
                                        <a href="{{ url('business/letters/'.$letter->id) }}"
                                           class="btn btn-sm btn-success" data-toggle="tooltip"
                                           data-original-title="View">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        @if($letter->user->type != 1)
                                            <a href="{{ url('business/letters/'.$letter->id.'/edit') }}"
                                               class="btn btn-sm btn-info" data-toggle="tooltip"
                                               data-original-title="Edit">
                                                <i class="fas fa-user-edit"></i>
                                            </a>
                                            {{--<a href="{{ url('business/letters/'.$letter->id.'/delete') }}"--}}
