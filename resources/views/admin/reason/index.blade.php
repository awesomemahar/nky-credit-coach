                    ...
                    <div class="row">
                        <div class="col-md-6 p-5">
                            <div class="">
                                ...
                                <hr class="mt-2">
                                <form class="new-event--form" action="{{ route('admin.reason.store')}}" method="POST">
                                    @csrf
                                ...
                                <table class="table table-bordered" >
                                    ...
                                    @foreach($reasons as $reason)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a  class="reason-edit" href="" data-reason="{{$reason->id}}" data-title="{{$reason->title}}"  data-content="{{$reason->content}}" data-status="{{ $reason->status }}" data-ref="{{ route('admin.reason.update',$reason) }}">
