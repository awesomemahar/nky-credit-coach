                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Total Standard Clients</h5>
                                        <span class="h2 font-weight-bold mb-0">{{ \App\Models\User::where('type', 3)->count()  }}</span>
                                    </div>
                                    <div class="col-auto">
                                        <div
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card card-stats">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Total Business Clients</h5>
                                        <span class="h2 font-weight-bold mb-0">{{ \App\Models\User::where('type', 2)->count()  }}</span>
                                    </div>
                                    <div class="col-auto">
                                        <div
                                                class="icon icon-shape {{$c_color}} text-white rounded-circle shadow">
                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h5 class="h3 mb-0">Total Subscriptions</h5>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
