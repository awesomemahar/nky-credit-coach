        ...
        <div class="row">
            <div class="col">
                ...
                <!-- Card header -->
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/letters') }}" method="post">
                            <div class="row">
                                @csrf
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control @error('letter_type') is-invalid @enderror"
                                                ...
                                                <option value="Bureau" {{ (old('letter_type') == 'Bureau') ? 'selected' : '' }}>Bureau
                                                </option>
                                                <option
                                                    value="Furnisher" {{ (old('letter_type') == 'Furnisher' && old('letter_type') != null) ? 'selected' : '' }}>
                                                    Furnisher
                                                </option>
                                                <option
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    <div class="text-right">
                                        <button class="btn btn-yellow">Add New Letter</button>
                                    </div>
                                </div>
                            </div>
                        </form>
