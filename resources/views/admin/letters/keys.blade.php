            ...
            <div class="col">
                ...
                <!-- Card header -->
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="box">
                            <a href="{{ url('admin/letters/create') }}" class="btn-yellow btn btn-sm"><i
                    ...
                    <div class="row">
                        <div class="col-md-6 p-5">
                            <div class="">
                                ...
                                <hr>
                                <form class="new-event--form" action="{{ route('admin.keys.post')}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label class="form-control-label">KEY(MAX LENGTH 30)</label>
                                        <input type="text" class="form-control"
                                               placeholder="" name="key" required maxlength="30">
                                    </div>
