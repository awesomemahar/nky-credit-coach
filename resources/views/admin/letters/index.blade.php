            ...
            <div class="col">
                ...
                @endif
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="mb-0">Letters Library</h3>
                        <a href="{{ url('admin/letters/create') }}" class="{{$c_color}} text-white btn btn-sm"><i
                    ...
                    <div class="table-responsive py-4">
                        <table class="table table-flush" id="datatable-basic">
                            ...
                            <tr>
                                <td>{{ $loop->index + 1 }}</td>
                                <td>{{ ($letter->title) ? $letter->title : 'N/A' }}</td>

                                <td>{{ ($letter->letter_type) ? $letter->letter_type : 'N/A' }}</td>
                                <td>{{ ($letter->status && $letter->status == 1) ? 'Active' : (($letter->status == 0) ? 'Inactive' : 'N/A' ) }}</td>
                                <td class="table-actions">
                                    <a href="{{ url('admin/letters/'.$letter->id) }}" class="btn btn-sm btn-success" data-toggle="tooltip"
                                       data-original-title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ url('admin/letters/'.$letter->id.'/edit') }}" class="btn btn-sm btn-info" data-toggle="tooltip"
                                       data-original-title="Edit">
                                        <i class="fas fa-user-edit"></i>
                                    </a>
                                    <a href="{{ url('admin/letters/'.$letter->id.'/delete') }}" class="btn btn-sm btn-danger table-action-delete"
                            ...
                            <div class="card">
                                <div class="row">
                                    <div class="col-md-3 text-center">
                                        <div
                                            class="card-header p-0 bg-blue text-center align-items-center justify-content-center h-100">
