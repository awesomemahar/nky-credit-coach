                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group row">
                            ...
                            <label for="example-text-input"
                                   class="col-md-10 col-form-label form-control-label font-weight-bolder">{{ ($video->status && $video->status == 1) ? 'Active' : (($video->status && $video->status == 0) ? 'Inactive' : 'N/A' ) }}</label>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group row">
